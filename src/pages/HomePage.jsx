...
function HomePage() {
  ...
  return (
    <main>
        ...
        >
          <div className="hero-copy">
            ...
            <p className="hero-copy__lead">
              BOMA or Badan Olahraga Mahasiswa is a student activity unit focused on sports at the
              Cibiru Campus of Universitas Pendidikan Indonesia. BOMA aims to facilitate and
              develop students&apos; interests, talents, and achievements in the field of sports at
              UPI Cibiru.
            </p>
            ...
            >
              {highlights.map((item) => {
                ...
                return (
                  <article className={`highlight-card${isActive ? ' is-active' : ''}`} key={item.id}>
                    <button
          ...
          <div className="hero-visual">
            <img className="hero-visual__echo" src={heroImage} alt="" aria-hidden="true" />
            <div className="hero-visual__main">
              <img src={heroImage} alt="Foto gedung biru untuk hero section BOMA" />
            </div>
      ...
      <section className="section section--soft section--overlap" id="profile">
        <div className="container">
          <div className="about-showcase">
            ...
            >
              ...
              <h2>Video Profile</h2>
              <p>
                Captured in this one-period video, with a spirit of sportsmanship, unity, and
                potential development, we serve as a platform that brings together students&apos;
            ...
            <div className="vision-copy scroll-reveal scroll-reveal--left">
              ...
              <div className="vision-copy__block">
                ...
                <p className="vision-copy__lead">
                  Menjadi rumah tumbuhnya insan olahraga berprestasi yang menjunjung sportivitas,
